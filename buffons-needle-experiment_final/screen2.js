...
//     document.getElementById('card_body2').innerHTML="\\[\\frac{needles\\ intersected}{needles\\ dropped}=\\]";
//    
//    
//    
//    document.getElementById("result2").innerHTML="\\[\\frac{"+total_intersection+"}{"+total_needle+"}\\]";
    rrr();
//    second_plot();
    updatePlot();
}
